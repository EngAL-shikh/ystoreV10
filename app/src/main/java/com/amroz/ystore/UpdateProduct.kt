...
//                && pprice_d.isNotEmpty() && pprice_y.isNotEmpty()) {
                ...
                val response=
                    productViewModel.updateProduct(product.product_id,titleProduct.text.toString(),
                        details.text.toString(),color.text.toString(),
                        product_features.text.toString(),price_y.text.toString().toInt(),price_d.text.toString().toInt())
