...
class UserReports : AppCompatActivity() {
    ...
    fun savePdf() {
        ...
        val table =
            Table(UnitValue.createPercentArray(floatArrayOf(8f, 23f, 15f))).useAllAvailableWidth()
...
//Add Header Cells
    ...
    private inner class ProductByUserAdapter(var product: List<Products>) :
        RecyclerView.Adapter<ProductsByUserHolder>() {
