...
class AddFeacher : AppCompatActivity() {
    ...
    fun addproduct(
        ...
        val responseLiveData: MutableLiveData<Response> = MutableLiveData()
        val newsRequest: Call<Response> = addApi.addProduct(
            title, details, images, color,
...
//    }
    ...
    fun addUser(
        name: String, email: String, password: String, chat_id: String,
        ...
        val newsRequest: Call<Response> =
            addApi.addUser(name, email, password, chat_id, phone, address, image)
        newsRequest.enqueue(object : Callback<Response> {
            override fun onFailure(call: Call<Response>, t: Throwable) {
